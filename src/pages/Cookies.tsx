  ...
  return (
    <PageShell label="Legal" title={<>Cookie <span className="text-gradient-blue">Policy</span></>} subtitle="Last updated: January 2026.">
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        ...
        <Section title="Advertising cookies">If Commons enables third-party advertising in the future (e.g. Google AdSense), those providers may set cookies to personalize ads and measure performance.</Section>
