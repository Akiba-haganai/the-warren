  ...
  return (
    <PageShell label="Legal" title={<>Terms of <span className="text-gradient-blue">Service</span></>} subtitle="Last updated: January 2026. By using Warren Hub you agree to these terms.">
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <S t="Using Campus Voices">You must be a student, alumnus, or approved partner of Copperbelt University or an affiliated institution to use certain features.</S>
        <S t="Your content">You retain ownership of what you post. You grant Campus Voices a limited license to display it within the platform. By posting, you agree that you are solely legally responsible for the content you submit.</S>
        ...
        <S t="Moderation & Removal">Campus Voices reserves the right to review, edit, or remove ANY content, for ANY reason, at ANY time, without prior notice. We do not guarantee the publication of any submitted content.</S>
        ...
        <S t="Disclaimer of Liability">The views, opinions, and statements expressed in stories and blogs are solely those of the individual authors. They do not reflect the official policy, stance, or position of Campus Voices, its creators, or Copperbelt University. Campus Voices acts solely as a neutral hosting platform.</S>
        <S t="Marketplace transactions">Campus Voices facilitates connections between students. We are not a party to transactions and are not responsible for the quality, safety or legality of listed items.</S>
