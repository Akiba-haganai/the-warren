  ...
  return (
    <PageShell label="Legal" title={<>Terms of <span className="text-gradient-blue">Service</span></>} subtitle="Last updated: January 2026. By using Warren Hub you agree to these terms.">
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <S t="Using Commons">You must be a student, alumnus, or approved partner of Copperbelt University or an affiliated institution to use certain features.</S>
        ...
        <S t="Disclaimer of Liability">The views, opinions, and statements expressed in stories and blogs are solely those of the individual authors. They do not reflect the official policy, stance, or position of Commons, its creators, or Copperbelt University. Commons acts solely as a neutral hosting platform.</S>
